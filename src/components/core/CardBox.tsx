...
const CardBox = (props: Readonly<CoreComponentsProps>) => {
  ...
  return (
    <div
      ...
      onClick={onClick}
      ref={elementRef}
      className={`relative w-full flex flex-col justify-start items-start duration-500 border border-[var(--textColor20)] hover:bg-zinc-800/10 hover:border-zinc-400/50 rounded-[var(--borderRadius)] overflow-hidden group box-shadow ${classNames}`}
    >
